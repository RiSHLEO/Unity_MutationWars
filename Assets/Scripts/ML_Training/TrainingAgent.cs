...
public class TrainingAgent : Agent
{
    ...
    [SerializeField] private Rigidbody2D _trainedRb;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(_trainedRb.linearVelocity / _moveSpeed);
    }
    ...
    {
        if (other.gameObject != this.gameObject && other.CompareTag("TrainedAgent"))
        {
            AddReward(3.0f);
            CummulativeReward = GetCumulativeReward();
            EndEpisode();
